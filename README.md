...
[Hilt Official Doc](https://dagger.dev/hilt/)
...
[First Program](https://www.notion.so/First-Program-e2d3dce5239744b4b2e92b378c152103)

[Kotlin Basic Part - 1 ](https://www.notion.so/Kotlin-Basic-Part-1-325c1c587424453c9849ef2a53bdb1ba)

[Kotlin Basic Part - 2, Control Flow](https://www.notion.so/Kotlin-Basic-Part-2-Control-Flow-e783c0da243b4cfb942dec195e538b48)

[Kotlin Basic Part - 3, Loop](https://www.notion.so/Kotlin-Basic-Part-3-Loop-de90ab3207b845ac9f9f6d399a95bea5)

[Kotlin Basic Part - 4, Fun](https://www.notion.so/Kotlin-Basic-Part-4-Fun-a96d6bc4ea304891a4ad0d59cb1b5513)

[Kotlin Basic Part - 5, Nullable](https://www.notion.so/Kotlin-Basic-Part-5-Nullable-041829815f7a43adbde2449524acfb41)
...
[Base Activity](https://www.notion.so/Base-Activity-025105f59502459f99c55ecf8642d0d0)

[OnActivityForResult, data refresh example](https://www.notion.so/OnActivityForResult-data-refresh-example-2e1690b48b7f4456a2a1e7e7d0af0cca)

[OnActivityResult, Update User Data When User Data Has been Changed](https://www.notion.so/OnActivityResult-Update-User-Data-When-User-Data-Has-been-Changed-cbdb352510294c5f953136c49317f1ea)

[OnActivityResult, practical example, notify updated data from other activity](https://www.notion.so/OnActivityResult-practical-example-notify-updated-data-from-other-activity-463ba32b0d7a43f49d140772b8e9ebbc)
...
[Go to setting screen (intent)](https://www.notion.so/Go-to-setting-screen-intent-a607a82a43574d1cb1da7ad3eaa7b37a)

[Add Camera & Album Photo Selection feature for imageView with Dexter](https://www.notion.so/Add-Camera-Album-Photo-Selection-feature-for-imageView-with-Dexter-46afecaa12214effaa05d83456e0607e)
...
[Firestore, Firebase storage tutorial](https://www.notion.so/Firestore-Firebase-storage-tutorial-cb755d5ccd7b48549055944f0c66224e)

[Firestore update](https://www.notion.so/Firestore-update-c1c5f5a8733648f19c4137f5af572dfe)

[Firestore read](https://www.notion.so/Firestore-read-66c5e24517bb490b94b16af826232dd4)

[Firebase, get data, query with ArrayList](https://www.notion.so/Firebase-get-data-query-with-ArrayList-6393ad40f56d49d2bea39161455dbefb)

[Firestore update, adding task](https://www.notion.so/Firestore-update-adding-task-22e621e1f4094a3cbf57642c7ea376bb)

[Firestore get detailed information with id](https://www.notion.so/Firestore-get-detailed-information-with-id-041dad7a866d479399dcc7d2f3fedc51)

[Firestore Creating a document](https://www.notion.so/Firestore-Creating-a-document-f95bd027286e48b69e0856ac007414dd)

[Firebase update](https://www.notion.so/Firebase-update-8e92e52f04494a75b19f86fce8ff2060)

[Firestore storage upload image](https://www.notion.so/Firestore-storage-upload-image-aec208b1bc9c498f83686e87cbcf65a9)

[Firestore Update Data & Firebase Storage Upload Image](https://www.notion.so/Firestore-Update-Data-Firebase-Storage-Upload-Image-1d4c4c86748449019110675625564316)

[Firebase in Gradle](https://www.notion.so/Firebase-in-Gradle-272baa9bd6824da681c253234b3f7f83)

[Put Firebase Config File](https://www.notion.so/Put-Firebase-Config-File-e69f59eb9d6a43c29bedead24965c288)

[FirebaseAuth SignUp](https://www.notion.so/FirebaseAuth-SignUp-00638d4876ff483cb923dee4ffb46687)

[FirebaseAuth SignIn](https://www.notion.so/FirebaseAuth-SignIn-40a3cc2d4fcf4645bc650371a7b6b604)

[Firestore, Auth Handling with Custom Class](https://www.notion.so/Firestore-Auth-Handling-with-Custom-Class-bcfd4589760c4808bc9a57955584b46c)
...
[Create Vector Asset](https://www.notion.so/Create-Vector-Asset-6d9e090bcecb4594a1277412c3655e65)
...
[Google Places & Map & Location example](https://www.notion.so/Google-Places-Map-Location-example-6186dd3a435d41d1b546f7bad0dce665)

# Image

[Reusable Image Chooser](https://www.notion.so/Reusable-Image-Chooser-f226f9a55221437191323d79af53d93c)
...
[Event Listener inside of recyclerView in recyclerView](https://www.notion.so/Event-Listener-inside-of-recyclerView-in-recyclerView-c98661fd826b44c2af0e76d8376dfd6a)

[RecyclerView in ItemView - initialize it on onBindViewHolder](https://www.notion.so/RecyclerView-in-ItemView-initialize-it-on-onBindViewHolder-69a335d54bc34229a9f37548aeecb155)

[Prepare RecyclerView with customizable layout (View Programming Programmatically)](https://www.notion.so/Prepare-RecyclerView-with-customizable-layout-View-Programming-Programmatically-a4ec57d5c0154fbca992c9f7483ac8a7)

[RecyclerView with OnClickListener](https://www.notion.so/RecyclerView-with-OnClickListener-8e405dff8b9142ab8f1d9dca44cbd7e7)

[RecyclerView Example without extending custom viewholder](https://www.notion.so/RecyclerView-Example-without-extending-custom-viewholder-1c6bf721344143409bf8fe87008dcf41)

[Basic ItemView with image, text, xml](https://www.notion.so/Basic-ItemView-with-image-text-xml-1586266e75c8429b9e5a709293a1fb0b)

[RecyclerView with interface OnClickListener](https://www.notion.so/RecyclerView-with-interface-OnClickListener-4f431d75633645ce8b1cd3a9fe321f21)

[RecyclerView, adding swipe to edit using ItemTouchHelper](https://www.notion.so/RecyclerView-adding-swipe-to-edit-using-ItemTouchHelper-7c7c7dfffe2444f9a2830c1c09bd287b)
...
[AlertDialog with default android provided image ](https://www.notion.so/AlertDialog-with-default-android-provided-image-939dabd50916456e9cb7273d9eaec439)

[Abstract Class Dialog](https://www.notion.so/Abstract-Class-Dialog-8fc954cfb84d4b3f87abf394d08b0770)

[Abstract Class Dialog ll](https://www.notion.so/Abstract-Class-Dialog-ll-278dca55e09143aea50e29eee901f50f)

[editText Set selection focus](https://www.notion.so/editText-Set-selection-focus-6f3362de2d684ace93548b909cfb0325)

[Menu - showAsAction, always](https://www.notion.so/Menu-showAsAction-always-e8f825bbeff1404daa68c68a3dd6ff1a)

[Create DropDown Menu](https://www.notion.so/Create-DropDown-Menu-7591768325414e1ab046a779c27baf58)

[Default AlertDialog](https://www.notion.so/Default-AlertDialog-5cb383b8d54d4eee918dbe0897b47321)

[Navigation Drawer](https://www.notion.so/Navigation-Drawer-7aa5a402c32544b3a7df1e4943107293)

[Custom SnackBar](https://www.notion.so/Custom-SnackBar-f8b29dec57ff406981f21e7f410f7a07)

[Button with Radius, Drawable xml](https://www.notion.so/Button-with-Radius-Drawable-xml-cbde8c667b60403eb5081b30d462140f)

[Gradient Background, button radius](https://www.notion.so/Gradient-Background-button-radius-ab8a2f0aae594b059b11a09fffc07ea3)

[Make window full screen](https://www.notion.so/Make-window-full-screen-a195a2b84d4b4e95b4155226ff004232)

[Define Custom Theme](https://www.notion.so/Define-Custom-Theme-421b6c6b38e24bc6b620c30cdd003998)

[Drawable-XML Gradient](https://www.notion.so/Drawable-XML-Gradient-09f0a6080b4248e58cb442aa42a5da67)

[Drawable XML - button with radius](https://www.notion.so/Drawable-XML-button-with-radius-19a411557c1e4f2cb33bb348b25dc7de)
...
[Custom Style, Custom ToolBar style ](https://www.notion.so/Custom-Style-Custom-ToolBar-style-9b73004f51904854a89b543949cc5591)

[Separated Date Picker ](https://www.notion.so/Separated-Date-Picker-2693d851b4174cde922fe5b1b307368d)

[Unclickable EditText](https://www.notion.so/Unclickable-EditText-d5fa33b9dd31476893f30bf2617d8703)

[Create AlertDialog with items](https://www.notion.so/Create-AlertDialog-with-items-26f5fdabfc9248a696faa14b641432eb)
...
[SQLite, insertion & read example](https://www.notion.so/SQLite-insertion-read-example-2f5c5389f7f344649f2e0f29f78f6b72)
...
[Define model - Data Class, Serializable vs Parcelable](https://www.notion.so/Define-model-Data-Class-Serializable-vs-Parcelable-b6638bc40b3e4af696b9b2bff992775d)
...
### Push Message, Abstract Class, drad and drop RecyclerView itemview, Firestore & Firebase, Parcelable, Abstract class dialog, BaseActivity, Navigation Drawer

[Trello Clone](https://github.com/paigeshin/AOS_Kotlin_Trello)
...
[Age In Minutes App](https://www.notion.so/Age-In-Minutes-App-3e2bc12bd4d840a0b02516550194799e)

[Calculator](https://www.notion.so/Calculator-b653bdd0fdf8403ab0ac0cd824a1e386)

[Quiz App](https://www.notion.so/Quiz-App-670a29b29ea4419ab57a298989a13c84)

[StartActivityForResult](https://www.notion.so/StartActivityForResult-0f8a362789504e3bb2294fe81a0935fe)

[Drawing Apps](https://www.notion.so/Drawing-Apps-c0b133212aa74b7ab3a9c87ef686bc74)

[KidsDrawingApp, practice ](https://www.notion.so/KidsDrawingApp-practice-5b403d21040e417688ef2415d78f661a)

[7 minutes workout](https://www.notion.so/7-minutes-workout-6b1c2166bdaa48e8858e015891b21102)

[Happy Place](https://www.notion.so/Happy-Place-88825957cd22405eae4b392517f7867f)

[Integrate ADMOB](https://www.notion.so/Integrate-ADMOB-b7036aef51b64570a5b42aa59a82990e)
